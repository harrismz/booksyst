                ...
                var form_register = Ext.widget('form', {
					...
					items         : [
						...
						},
						{
                            ...
                            id					: 'xt_tablet',
                            name				: 'xt_tablet',
                            fieldLabel			: 'SELECT LESSON MEETING',
                            emptyText			: 'SELECT LESSON MEETING',
        ...
        var grid = Ext.create('Ext.grid.Panel',{
            ...
            tbar		:[{
                        ...
                        },
                        {
                            xtype  : 'button',
                            id     : 'btn_update',
                            text   : 'Edit Lesson Meeting Reservation',
                            iconCls: 'icon-edit-icon8',
            ...
            columns     : [
							...
							{ header: 'LESSON MEETING NAME',	dataIndex: 'tabletcode2', width:250, tdCls:'wrap-text',  align:'left'},
