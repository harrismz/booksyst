					...
					items: [
						{
							...
							columns		: [
								...
								{ text: 'FOR DEPARTMENT',	dataIndex: 'dept',			width: 100, tdCls:'wrap-text', align:'left' },
								{ text: 'DRIVER', 			dataIndex: 'driver', 		width: 100, tdCls:'wrap-text', align:'left' },
								{ text: 'CALL NUMBER', 		dataIndex: 'driver_call',	width: 110, tdCls:'wrap-text', align:'left' },
								{ text: 'STATUS', 			dataIndex: 'status', 		width: 115, tdCls:'wrap-text', align:'left' },
								{ text: 'MERK', 			dataIndex: 'carname', 		width: 100, tdCls:'wrap-text', align:'left' },
							]
						}
					],
				});
                    ...
                    items			: [
                        {
                            ...
                            listConfig			:{
                                getInnerTpl	: function() {
                                    return '<div><b>{platno}</b> - ( {dept} )</div>';
                                }
                            },
                        },
						{
