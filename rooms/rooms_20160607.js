...
Ext.onReady(function(){
    ...
    //==========================DS STORE===========================================================================
        ...
        Ext.define('M_view',{
            extend: 'Ext.data.Model',
            fields: ['id_rentroom','roomcode','date','start_time','end_time','dept','incharge','purpose','remark']
        });
					...
					var form_update = Ext.widget('form', {
						...
						items         : [
							...
							},
							{
								...
								listConfig			:{
									getInnerTpl	: function() {
										return '<div>ROOM - <b>{roomname}</b> ( {position} )</div>';
									}
								},
                    ...
                    items			: [
                        {
                            ...
                            listConfig			:{
                                getInnerTpl	: function() {
                                    return '<div>ROOM - <b>{roomname}</b></div>';
                                }
                            },
    ...
    //==========================GRID==================================================================================
        var grid = Ext.create('Ext.grid.Panel',{
            ...
            columns     : [
							...
							{ header: 'ROOM NAME',	dataIndex: 'roomcode',    flex:1, tdCls:'wrap-text',  align:'left'},
							{ header: 'DATE', 		dataIndex: 'date',    flex:1, tdCls:'wrap-text',  align:'left',renderer: Ext.util.Format.dateRenderer('d F Y')},
							{ header: 'START TIME', dataIndex: 'start_time',    flex:1, tdCls:'wrap-text',  align:'left'},
							{ header: 'END TIME',   dataIndex: 'end_time',    flex:1, tdCls:'wrap-text',  align:'left'},
