...
try{
	//$sql    = "select id_tablet, tabletname, position from RENT_tabletdata where dept = 'MEETING' order by position asc";
	$sql    = "SELECT id_tablet, tabletname, position, tabletname2 FROM RENT_tabletdata WHERE (dept = 'TABLET') ORDER BY id_urutan asc";
