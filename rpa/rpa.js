...
Ext.onReady(function(){
    ...
    //==========================FUNCTION==============================================================================
					...
					var form_update = Ext.widget('form', {
						...
						items         : [
							...
							},
							{
								xtype	: 'hiddenfield',
								id		: 'xt_idrentrpa_upd',
								name	: 'xt_idrentrpa_upd',
								value	: rec[0].data.id_rentrpa,
							},
							{
								xtype				: 'combo',
								id					: 'xt_rpa_upd',
								...
								queryMode			: 'local',
								store				: ds_rpadata,
								displayField		: 'rpaname',
								valueField			: 'rpaname',
								allowBlank			: false,
								value				: rec[0].data.rpacode,
								listConfig			:{
									getInnerTpl	: function() {
										return '<div><b>{rpaname2}</b> ( ex-{rpaname} )</div>';
									}
								},
								...
								handler  	: function() {
									...
									if (form.isValid()) {
										form.submit({
											...
											success : function(form, action) {
												Ext.getCmp('xt_rpa_upd').focus(false, 1000);
												ds_view.loadPage(1);
												popwindow.close();
		...
		/*function combinecolumn(value, meta, record, rowIndex, colIndex, store){
			return '<b>'+value+'</b> ( ex-'+ record.get('rpacode') +' )';
		}*/
		/*end combine column*/
    //==========================FUNCTION==============================================================================
    //==========================VARIABLE==============================================================================
